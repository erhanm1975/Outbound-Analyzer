                    ...
                    <div className="relative group">
                        <div className="flex items-center space-x-2 px-3 py-1.5 bg-slate-900 rounded-lg border border-slate-800 hover:border-slate-700 transition-colors text-slate-400 relative">
                            ...
                            >
                                ...
                                {activeFile && (
                                    <>
                                        <option value="__STANDARD__" className="bg-slate-900 text-emerald-400 font-semibold">[Standard Data]</option>
                                        <option value="__TARGET__" className="bg-slate-900 text-blue-400 font-semibold">[Target Data]</option>
                                    </>
                                )}
