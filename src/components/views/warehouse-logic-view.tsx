                ...
                {viewMode === 'tasks' && (
                    <div className="relative">
                        ...
                        >
                            ...
                            {Array.from(new Set(tasks.map(t => t.TaskType))).sort().map(type => (
                        ...
                        <table className="w-full text-left text-xs">
                            ...
                            <tbody className="divide-y divide-slate-800/50">
                                {filteredTasks.slice(0, 500).map((t, i) => {
                                    const isUnprod = t.TaskType === 'Break' || t.TaskType === 'No Activity' || t.TaskType === 'Delay' || t.TaskType === 'Implicit Break/Delay' || t.JobType === 'Break';
                                    return (
