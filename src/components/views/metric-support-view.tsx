...
import { TaskDurationAuditTable } from '../tables/task-duration-audit-table';
...
export function MetricSupportView({ data, metric, onBack, benchmarkData, isBenchmark = false, stats }: MetricSupportViewProps) {
    ...
    const generateSpanMatrix = (subset: ShiftRecord[]) => {
        ...
        dayGroups.forEach((records, dateStr) => {
            ...
            if (maxFinish.getTime() - minStart.getTime() > TIME.ONE_DAY_MS) {
                ...
                minStart = new Date(maxFinish.getTime() - TIME.ONE_DAY_MS);
            }
