...
export function AdaptationInsightsView({ data, config }: JobDictionaryViewProps) {
    ...
    const analysis = useMemo(() => {
        ...
        const utilTargetTypes = new Set([TaskTypeId.PUT_TO_WALL, AdaptationJobProfile.MIXED_SINGLES, AdaptationJobProfile.MULTI_ITEM, AdaptationJobProfile.COMPLEX]);
        ...
        jobs.forEach((job, jobCode) => {
            let type = AdaptationJobProfile.UNKNOWN;
